  ...
  return (
    <div class="content">
     <h1>About me</h1>
        ...
        <p>Brief summary:</p>
          <ul class="lista">
      <li><strong>2021</strong> - Kept improving front-end skills using <a href="https://www.theodinproject.com/paths/foundations/courses/foundations" target="_blank" rel="noopener noreferrer">The Odin Project</a> and <a href="https://www.codewars.com/" target="_blank" rel="noopener noreferrer">Codewars</a>. Built more side projects (Node.js, React.js). Improved knowledge in Git.</li>
